...
#     subnet_id = "/subscriptions/5670c878-c5f9-4979-93b8-68f58fb292ca/resourceGroups/example-rg/providers/Microsoft.Network/virtualNetworks/example-vnet/subnets/aks-subnet"
#   }
# }
